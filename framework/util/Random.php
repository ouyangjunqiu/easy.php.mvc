...
class Random
{
    ...
    public static function createPassword($length = self::DEFAULT_RANDOM_NUMBER_LENGTH)
    {
        ...
        return self::createRandomString($bigChar, self::RANDOM_STRING_ALPHA_NOCASE) . self::createRandomString($char, self::RANDOM_STRING_LOWER_ALPHA) . self::createRandomString($number, self::RANDOM_STRING_NUMBER);
    }
     ...
     * @return boolean
     */
    public static function randByWeight($weight)
    {
        $flag = self::getRandomKeyByWeight(array('1' => $weight, '0' => 100 - $weight));
        return $flag;
    }
